...
extern class Projection {
	...
	dynamic static function container2dToLocal<T>(position:IPoint, ?from:Dynamic, ?point:T, ?skipUpdate:Bool, ?step:TRANSFORM_STEP):T;
	static function container3dWorldTransform():Dynamic;
	dynamic static function container3dToLocal<T>(position:IPoint, ?from:Dynamic, ?point:T, ?skipUpdate:Bool, ?step:TRANSFORM_STEP):T;
